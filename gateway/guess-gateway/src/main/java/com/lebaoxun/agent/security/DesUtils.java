...
public class DesUtils {
  ...
  public DesUtils() {
	  this(WebConstants.DES_SECURITY_KEY);
  }
  
  public DesUtils(String k) {
	  init(k);
  }
  ...
  /*public void main(String[] args) {
    try {
      ...
      System.out.println("解密后的字符：" + DesUtils.decrypt(DesUtils.encrypt(test)));
      
      System.out.println("解密后的字符：" + DesUtils.decrypt("baf439befd79fa89dfe46ef624c15994"));
    }
    catch (Exception e) {
      e.printStackTrace();
    }
