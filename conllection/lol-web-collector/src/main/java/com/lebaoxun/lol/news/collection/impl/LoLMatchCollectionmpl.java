package com.lebaoxun.lol.news.collection.impl;
...
@Repository
public class LoLMatchCollectionmpl implements ILoLMatchNetworkSpider {

	private Logger logger = LoggerFactory
			.getLogger(LoLMatchCollectionmpl.class);
	...
	@Override
	public List<LoLMatch> findByLeagueAndTime(String league, String season,
			Integer pageNum, Integer size, Date start, Date end) {
		// TODO Auto-generated method stub
		List<LoLMatch> gameMatchs = new ArrayList<LoLMatch>();
		try {
