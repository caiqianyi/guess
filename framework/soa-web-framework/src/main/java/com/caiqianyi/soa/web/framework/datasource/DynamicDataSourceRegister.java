package com.caiqianyi.soa.web.framework.datasource;
...
public class DynamicDataSourceRegister
    ...
    public DataSource buildDataSource(Map<String, Object> dsMap) {
        try {
            ...
            String username = ConfigTools.decrypt(dsMap.get("username").toString());
            String password = ConfigTools.decrypt(dsMap.get("password").toString());
