...
public class LoLGuessTopicController {
	...
	SuccessMessage createAll(@RequestBody GameMatch match,
		...
		return new SuccessMessage(lolGuessTopicService.createAll(match, createBy, clubId));
	}
	/**
	 * 创建关于比赛胜负竞猜话题
	 * @param match 比赛
	...
	SuccessMessage createTopicForSF(@RequestBody GameMatch match,
			@RequestParam(value="createBy",required=false)String createBy,
			@RequestParam(value="clubId",required=false)Integer clubId){
		return new SuccessMessage(lolGuessTopicService.createTopicForSF(match, createBy, clubId));
	}
	...
	SuccessMessage createTopicForBF(@RequestBody GameMatch match,
			@RequestParam(value="createBy",required=false)String createBy,
			@RequestParam(value="clubId",required=false)Integer clubId){
		return new SuccessMessage(lolGuessTopicService.createTopicForBF(match, createBy, clubId));
	}
	...
	SuccessMessage createTopicForFirst(@RequestBody GameMatch match,
			@RequestParam(value="createBy",required=false)String createBy,
			@RequestParam(value="clubId",required=false)Integer clubId){
		return new SuccessMessage(lolGuessTopicService.createTopicForFirst(match, createBy, clubId));
	}
	...
	SuccessMessage createTopicForFirstBlood(@RequestBody GameMatch match,
			@RequestParam(value="createBy",required=false)String createBy,
			@RequestParam(value="clubId",required=false)Integer clubId){
		return new SuccessMessage(lolGuessTopicService.createTopicForFirstBlood(match, createBy, clubId));
	}
	...
	SuccessMessage createTopicForFirstTurret(@RequestBody GameMatch match,
			@RequestParam(value="createBy",required=false)String createBy,
			@RequestParam(value="clubId",required=false)Integer clubId){
		return new SuccessMessage(lolGuessTopicService.createTopicForFirstTurret(match, createBy, clubId));
	}
	...
	SuccessMessage createTopicForSOD(@RequestBody GameMatch match,
			@RequestParam(value="createBy",required=false)String createBy,
			@RequestParam(value="clubId",required=false)Integer clubId){
		return new SuccessMessage(lolGuessTopicService.createTopicForSOD(match, createBy, clubId));
	}
}
