...
public enum _11x5Cat {
	...
	private String[] lotterys = new String[]{"01","02","03","04","05","06","07","08","09","10","11"};
	...
	public static _11x5Cat getCatByKindOf(String kindOf){
		_11x5Cat cats[] = _11x5Cat.values();
		for(_11x5Cat cat :cats){
